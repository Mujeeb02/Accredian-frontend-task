  ...
  return (
    <div className="relative h-[550px] bg-[#EEF5FF] w-[1360px] flex justify-between items-center text-3xl ml-[90px] rounded-md shadow-md overflow-hidden">
      <div className="">
        ...
        <button onClick={handleOpenModal} className="w-[192px] h-[54px] bg-[#1A73E8] rounded-[8px] ml-[50px] text-[#FFFFFF] text-[20px] leading-[24px] font-[400] flex items-center justify-center">
          Refer Now
        </button>
      </div>
      <div className="w-[814px] h-[725px] overflow-hidden relative">
        <div className="absolute rotate-180 mt-[218px] left-52 z-[0] h-[87px] w-[157px]">
